  ...
  return (
    <>
      <style>{`
        ...
        .loader {
          --background: linear-gradient(135deg, hsl(243 75% 59%), hsl(243 75% 63%));
          --shadow: rgba(0, 0, 0, 0.08);
          --text: #6c7486;
          --page: hsl(0 0% 100% / 0.9);
          --page-fold: hsl(0 0% 100% / 1);
          --duration: 3s;
        ...
        .loader div ul li {
          ...
          animation: var(--duration) cubic-bezier(0.4, 0, 0.2, 1) infinite;
        }
